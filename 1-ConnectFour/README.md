...
1. Expliquez comment vous souhaitez procéder pour « brancher » un joueur contrôlé par l’ordinateur ainsi qu’un système permettant l’historisation et la persistance.
2. Gardez bien en tête que les parties prenantes ont énormément insisté sur la nécessité de process de qualité robuste. Cette nouvelle fonctionnalité doit donc être testée